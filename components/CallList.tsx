...
import { Call, CallRecording, CallState } from '@stream-io/video-react-sdk'
  ...
  return (
    <div className='grid grid-cols-1 gap-5 xl:grid-cols-2'>
      {calls && calls.length > 0 ? calls.map((meeting: Call | CallRecording) => (
        ...
        title={(meeting as Call).state?.custom?.description?.substring(0, 26) || __filename?.substring(0, 20) || 'No description'}
